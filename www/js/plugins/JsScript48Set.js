...
var parameters = PluginManager.parameters('JsScript48Set');
...
var displayCount = PluginManager.parameters('JsScript47Set').displayCount==='true';
...
var path = require('path');
    ...
    var splitAnimImages = PluginManager.parameters('JsScript49Set').animImages||[];
    var ext = '.png';
    for(var i=length-1; i>=0; i=(i-1)|0){
        var image = images[i];
...
var file = '/*'+':\n * @help 
    ...
    var animImages = PluginManager.parameters('JsScript49Set').animImages||null;
...
this.clearInputting();
}else if(keyCode===KEY_CODE.tab || Input.isTriggered('right')){
...
var num = keyCode-numKeyCode;
chara = Number(keyCode-numKeyCode)
}else if(keyCode===KEY_CODE.minus){
chara = '-';
this._inputting = '';
}else if(keyCode===KEY_CODE.dot){
...
}else if(keyCode === KEY_CODE.bracket){
this.setEditing(-1);
this._inputtingTime = '';
this.refreshParts();
