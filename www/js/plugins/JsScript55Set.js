...
Yanfly.Parameters = PluginManager.parameters('JsScript55Set');
...
Game_System.prototype.addMessageBacklog = function(text) {
  ...
  text = this.convertMessageBacklogText(text.replace("\c[15]", "\\oc[15]")); 
...
Yanfly.MsgBacklog.Window_Message_isAnySubWindowActive = Window_Message.prototype.isAnySubWindowActive;
