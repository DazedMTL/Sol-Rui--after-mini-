...
if (!(Khas && Khas.Graphics && Khas.Graphics.version >= 1.1)) {
  var currentPlugin = "JsScript14Set";
  var missingPlugin = "JsScript13Set";
 ...
 * @requiredAssets img/lights/blue
  * @requiredAssets img/lights/blue2
 ...
 * @requiredAssets img/lights/
 * @requiredAssets img/lights/pink2
 ...
 * @requiredAssets img/lights/tungsten
  * @requiredAssets img/lights/tungsten2
...
flashlight: {
    ...
    intensity: 100
    variation: 0,
    offset_x: {2: -12, 4: -72, 6: 72, 8: 16 }, 
    offset_y: {2: 72, 4: 0, 6: 16, 8: -72 },   
    syncWithDirection: true                    
},
...
Khas.Lighting.PARAMETERS = PluginManager.parameters("JsScript14Set");
...
PixiOutOfDateError.prototype.constructor = PixiOutOfDateError;
  ...
  Object.defineProperty(Game_Map.prototype, 'battleLighting', {
      get: function() { return this._battleLighting; },
  });
...
function Khas_Lighting() { this.initialize.apply(this, arguments); }; 
  ...
  Khas_Lighting.prototype.update = function() {
      if (GrpSkipCount == 0 && ConfigManager.renderFpsHalf && Must60FPSFlame <= 0) {
        return;
      }
